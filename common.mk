...
PRODUCT_COPY_FILES += \
    ...
    $(COMMON_PATH)/rootdir/res/bc/fix_permissions:root/res/bc/fix_permissions \
    $(COMMON_PATH)/rootdir/res/bc/fstrim:root/res/bc/fstrim \
    $(COMMON_PATH)/rootdir/res/misc/boeffla-config-reset-v2.zip:root/res/misc/boeffla-config-reset-v2.zip \
